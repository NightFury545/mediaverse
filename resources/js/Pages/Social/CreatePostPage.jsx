...
const PostCreatePage = () => {
    ...
    const handleSubmit = () => {
        ...
        if (content.replace(/<(.|\n)*?>/g, '').length > 5000) {
            toast.error('Вміст не може перевищувати 5000 символів');
            return;
        }
            ...
            <Box sx={{minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center'}}>
                <Box sx={{textAlign: 'center'}}>
                    <Typography variant="h6" sx={{color: '#ffffff', mb: 2}}>
                        Будь ласка, увійдіть, щоб створити пост
                    </Typography>
                    <Button
                        variant="contained"
                        href="/login"
    ...
    return (
        <Box sx={{minHeight: '100vh', pt: 4, pb: 8, position: 'relative', overflow: 'hidden'}}>
            ...
            <Container maxWidth="xl" sx={{px: {xs: 2, sm: 3, md: 4}}}>
                <motion.div initial={{opacity: 0, y: 20}} animate={{opacity: 1, y: 0}} transition={{duration: 0.5}}>
                    <Grid container spacing={4}>
                        {/* Ліва колонка - Попередній перегляд (тільки на великих екранах) */}
                        {!isMobile && (
                            <Grid item md={5} lg={4}>
                                <motion.div
                        ...
                        {/* Права колонка - Форма (займає весь простір на мобільних, 7 колонок на десктопах) */}
                                ...
                                >
                                    ...
                                    <FormControl fullWidth sx={{mb: 3}}>
                                        <Typography variant="subtitle2"
                                                    sx={{color: '#e0e0e0', mb: 1, fontSize: '0.9rem'}}>
                                            Видимість
                                        </Typography>
                                        <Select
                                            value={visibility}
            ...
            {/* Модаль для попереднього перегляду */}
            <Modal
                open={openPreview}
                onClose={() => setOpenPreview(false)}
                sx={{
                    display: 'flex',
                    alignItems: 'flex-start', // Починаємо згори, щоб контент не обрізався
                    justifyContent: 'center',
                    backdropFilter: 'blur(5px)',
                    // Додаємо прокрутку для модалки
                    overflowY: 'auto',
                    padding: { xs: '8px', sm: '16px' },
                    // Запобігаємо обрізанню контенту
                    minHeight: '100vh',
            ...
            >
                <motion.div
                    ...
                    style={{
                        ...
                        maxWidth: '600px',
                        margin: 'auto',
                        paddingTop: '16px', // Відступ зверху для мобільних
                        paddingBottom: '16px',
                    }}
                >
                    <Box
                        sx={{
                            ...
                            mx: 'auto',
                            position: 'relative',
                            // Видаляємо maxHeight, щоб весь вміст був доступний
                            overflow: 'visible',
                            boxSizing: 'border-box',
                            display: 'flex',
